const STORY_DELTA_BY_OUTCOME = Object.freeze({
  correct: Object.freeze({
    event_integrity: 3,
    relationship_connection: 1,
    uncertainty: -3,
  }),
...
const option = (
  ...
  narrative_effect: {
    metrics_delta: STORY_DELTA_BY_OUTCOME[outcome],
    consequence: effectSummary,
    story_tag: `orbital_${outcome}`,
  },
})

export const ORBITAL_EVENTS = Object.freeze([
  Object.freeze({
    id: 'debris_close',
    title: '近距离碎片交会',
...
export const ORBITAL_EVENT_BY_ID = Object.freeze(
  Object.fromEntries(ORBITAL_EVENTS.map((event) => [
    ...
    Object.freeze({
      ...event,
      option_by_id: Object.freeze(
        Object.fromEntries(event.options.map((item) => [item.id, item])),
      ),
    }),
  ])),
)
