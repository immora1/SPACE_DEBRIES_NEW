...
const initialState = {
  ...
  storyVersion: 0,
  storyStatus: null,
  storyFlowVersion: null,
  storyCheckpoint: null,
  currentStoryNode: null,
  currentStoryOptions: [],
  currentStoryInteraction: null,
  ...
  persist(
    (set, get) => ({
      ...
      setStorySnapshot: (story) => set((state) => {
        const restoredMaterials = story.public_game_state?.satellite_build?.materials || {}
        const restoredMission = story.public_game_state?.mission?.action_id || null
        return {
          storyId: story.story_id,
          storyVersion: story.version,
          storyStatus: story.status,
          storyFlowVersion: story.story_flow_version || null,
          ...
          currentStoryInteraction: story.current_interaction || null,
          ...
          gameStorySync: story.game_story_sync || null,
          artifactProgress: story.artifact_progress || null,
          materials: Object.keys(restoredMaterials).length
